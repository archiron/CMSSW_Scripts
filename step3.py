...
# with command line options: step3 --conditions auto:phase1_2024_realistic --datatier GEN-SIM-RECO,MINIAODSIM,NANOAODSIM,DQMIO --era Run3_2024 --eventcontent RECOSIM,MINIAODSIM,NANOEDMAODSIM,DQM --filein file:step2.root --fileout file:step3.root --geometry DB:Extended --nStreams 4 --nThreads 8 --no_exec --number 10 --python_filename step_3_cfg.py --step RAW2DIGI,L1Reco,RECO,RECOSIM,PAT,NANO,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@ExtraHLT+@miniAODDQM+@nanoAODDQM
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring([
        'file:' + outputPath + '/step2_3000' + '_' + '%003d'%ind1 + '.root',
        'file:' + outputPath + '/step2_3000' + '_' + '%003d'%ind2 + '.root',
        'file:' + outputPath + '/step2_3000' + '_' + '%003d'%ind3 + '.root',
    ]),
