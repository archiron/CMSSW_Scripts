...
# with command line options: ZEE_14TeV_TuneCP5_cfi --beamspot DBrealistic --conditions auto:phase1_2024_realistic --datatier GEN-SIM --era Run3_2024 --eventcontent FEVTDEBUG --fileout file:step1.root --geometry DB:Extended --nStreams 4 --nThreads 8 --no_exec --number 10 --python_filename step_1_cfg.py --relval 9000,100 --step GEN,SIM
...
if len(sys.argv) > 1:
    ...
    ind = 0
    path = ''
    max_number = 9000 # number of events
